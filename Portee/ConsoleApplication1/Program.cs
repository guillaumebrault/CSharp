...
namespace ConsoleApplication1
{
    ...
    class Centrale
    {
        ...
        {
            // foreach (var pompe in ListePompe)                // Pompe est de type object
            // {
    ...
    class PompeHydraulique
    {
        ...
        {
            Console.WriteLine("Lanchement de la pompe hydraulique : Temperature={0}, Pression={0}", args.Temperature, args.Pression );
        }
    }
    class PompeElectrique
    {
        public void Refroidir(CentraleEventArgs args)
        {
            Console.WriteLine("Lanchement de la pompe électrique");
        }
    ...
    class PompeManuelle
    {
        public void Refroidir(CentraleEventArgs args)
        {
            Console.WriteLine("Lanchement de la pompe manuelle");
        }
